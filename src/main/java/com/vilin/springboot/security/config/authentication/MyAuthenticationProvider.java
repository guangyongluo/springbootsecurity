package com.vilin.springboot.security.config.authentication;

import com.vilin.springboot.security.exception.VerificationCodeException;
...
public class MyAuthenticationProvider extends DaoAuthenticationProvider {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails, UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken) throws AuthenticationException {
        ...
        System.out.println(MyAuthenticationProvider.class + " : additionalAuthenticationChecks() method");
        // 检验图形验证码
